...
VJCURATOR_WINVERSION=vj-curator-$(VERSION)-winarm64
else
if HAVE_WIN64
WINVERSION=vlc-$(VERSION)-win64
VJCURATOR_WINVERSION=vj-curator-$(VERSION)-win64
else
WINVERSION=vlc-$(VERSION)-win32
VJCURATOR_WINVERSION=vj-curator-$(VERSION)-win32
endif
endif
...
package-vjcurator-win32-portable: package-win-strip
...
.PHONY: package-win-install package-win-common package-win-strip package-win32-src package-win32-exe package-win32-zip package-win32-debug-zip package-win32-7zip package-vjcurator-win32-portable package-win32-debug-7zip package-win32-cleanup package-win32 package-win32-debug package-wince
