...
T.Pane {
    ...
    RowLayout {
        ...
        T.Label {
            ...
            Layout.preferredWidth: VLCStyle.dp(44, VLCStyle.scale)
            Layout.fillHeight: true
            ...
            text: String(MainPlaylistController.count)
            color: volControl.colorContext.fg.primary
            font.pixelSize: VLCStyle.fontSize_normal
            font.weight: Font.DemiBold

            Accessible.name: qsTr("Remaining clips")
